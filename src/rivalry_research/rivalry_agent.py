...
Your task is to:
1. Analyze the provided entity data, direct relationships, and shared properties
...
- Priority disputes often arise when both people claim similar discoveries/achievements
